...
| [Synonym skills URL supplied for this review](https://github.com/synonymdev/synonym-skills) | Anonymous GitHub page and API requests returned 404. Visitors cannot use this URL without access. | Do not publish this URL as a public entry point. |
